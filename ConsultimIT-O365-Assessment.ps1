...
<style>
:root {
  --primary:#2c3e8c;--primary-light:#3d52c4;--primary-dark:#1a2660;
  --danger:#c0392b;--warning:#f39c12;--success:#27ae60;--info:#2980b9;
...
[data-theme="dark"] .sev-info     {background:rgba(59,130,246,.2);color:#93c5fd;}
...
.ms-score-bar-fill{height:100%;border-radius:100px;background:linear-gradient(90deg,var(--primary),#5c6bc0);transition:width 1.5s ease;}
...
<nav class="topbar">
  <div class="brand">
    <div>
      <div class="brand-logo">Consultim<span>-IT</span></div>
